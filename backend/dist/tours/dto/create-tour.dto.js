...
exports.CreateTourDto = exports.CreateActivityDto = void 0;
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
var PricingType;
(function (PricingType) {
    PricingType["FIXED"] = "FIXED";
    PricingType["RANGE"] = "RANGE";
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateActivityDto.prototype, "pricingType", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateActivityDto.prototype, "fixedPrice", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateActivityDto.prototype, "minPrice", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateActivityDto.prototype, "maxPrice", void 0);
__decorate([
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateActivityDto.prototype, "order", void 0);
class CreateTourDto {
}
...
], CreateTourDto.prototype, "availableDates", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.IsUrl)({ require_tld: false }, { each: true }),
    __metadata("design:type", Array)
], CreateTourDto.prototype, "photoUrls", void 0);
__decorate([
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => CreateActivityDto),
    __metadata("design:type", Array)
], CreateTourDto.prototype, "activities", void 0);
